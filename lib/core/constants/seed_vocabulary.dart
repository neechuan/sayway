...
/// Pre-seeded core vocabulary — 40 high-frequency AAC words.
/// Uses emojis as symbols (no external image dependency for MVP).
class SeedVocabulary {
  ...
  static SymbolCard _card(
    ...
    return SymbolCard(
      label: label,
      emoji: emoji,
      symbolPath: 'assets/symbols/$assetKey.png',
      category: category,
